These are automated UI tests for the Help Your Neighbors project.
...
If the tests theselves no longer work, it is most likely because one of the XPaths has changed.
